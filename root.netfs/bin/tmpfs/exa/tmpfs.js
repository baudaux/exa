...
var ASM_CONSTS = {
  ...
  try {
  	...
  	/* Modified by Benoit Baudaux 26/12/2022 */
  	return sock.sock_ops.bind(sock, info.addr, info.port);
  	/*return 0;*/
    } catch (e) {
