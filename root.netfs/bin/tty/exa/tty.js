...
var ASM_CONSTS = {
  2091: ($0) => { let msg = {}; msg.type = 2; msg.data = UTF8ToString($0); Module["term_channel"].port1.postMessage(msg); }
};
function probe_terminal() { let ret = Asyncify.handleSleep(function (wakeUp) { Module["term_channel"] = new MessageChannel(); Module["term_channel"].port1.onmessage = (e) => { console.log("Message from Terminal: "+JSON.stringify(e.data)); if (e.data.type == 0) { wakeUp(0); } }; let msg = { }; msg.type = 0; window.parent.postMessage(msg, '*', [Module["term_channel"].port2]); }); return ret; }
...
var ___start_em_js = Module['___start_em_js'] = 1716;
var ___stop_em_js = Module['___stop_em_js'] = 2091;
